...
void inputPatent(char message[], char patent[]){
    ...
    int i,validation;
    do{
        inputStr(message,auxPatent);
        validation = validPatent(auxPatent);
        switch(validation){
            case 0:
                printf("Error, la patente debe tener 7 caracteres \n\n");
                break;
            case -1:
                printf("Error, los primeros 3 caracteres deben ser letras \n\n");
                break;
            case -2:
                printf("Error, el caracter medio debe ser un guion \n\n");
                break;
            case -3:
                printf("Error, los ultimos 3 caracteres deben ser numericos \n\n");
                break;
            case 1:
                loop = FALSE;
                break;
    ...
    for(i=0; i<3; i++){
        auxPatent[i] = toupper(auxPatent[i]);
    }
    strcpy(patent,auxPatent);
}
